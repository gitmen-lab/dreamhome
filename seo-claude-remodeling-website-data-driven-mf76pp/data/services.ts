...
export const services: Service[] = [
  {
    ...
    imageAlt:
      "Freshly stained dark wood double entry doors on a stone home exterior after refinishing",
    priceRange: "$$",
    duration: "2–7 days",
  },
  {
    ...
    imageAlt:
      "Spacious room with newly installed hardwood flooring and natural light",
    priceRange: "$$",
    duration: "2–5 days",
  },
  {
    ...
    imageAlt:
      "Completed powder room remodel with wainscoting, pedestal sink, and brass fixtures",
    priceRange: "$$$",
    duration: "2–3 weeks",
    pricingTiers: [
      {
  ...
  },
  {
    ...
    imageAlt:
      "Bright renovated kitchen with white cabinetry, brass hardware, and hardwood flooring",
    priceRange: "$$$$",
    duration: "4–8 weeks",
  },
  {
    ...
    imageAlt:
      "Contractor in a hard hat installing a drywall panel on an interior wall",
    priceRange: "$",
    duration: "1–3 days",
  },
  {
    ...
    imageAlt:
      "Interior room mid-renovation with demolition tools and construction materials",
    priceRange: "$",
    duration: "1–4 days",
  },
];
