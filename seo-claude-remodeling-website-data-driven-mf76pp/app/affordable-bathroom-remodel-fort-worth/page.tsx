...
const cosmeticTier = service.pricingTiers!.find((t) => t.tier === "Cosmetic refresh")!;

export const metadata: Metadata = buildMetadata({
  title: "Affordable Bathroom Remodel Fort Worth | 50% Off - My Dream Home Remodeling",
  description:
    "Affordable bathroom remodels in Fort Worth starting at $2,500, plus 50% off installation this month. Licensed & insured, free in-home estimate.",
  path: "/affordable-bathroom-remodel-fort-worth",
...
const faqs = [
  {
    question: "What's the most affordable way to remodel a bathroom?",
    answer:
      "A cosmetic refresh — new paint, fixtures, a vanity top, hardware, and lighting with no layout change — is the most affordable option, typically $2,500–$10,000. It's the fastest way to update a dated bathroom without the cost of moving plumbing or tearing out tile.",
  },
  {
    question: "How much does a bathroom remodel cost in Fort Worth?",
    answer:
      "Most bathroom remodels range from about $2,500 for a cosmetic refresh to $12,000–$30,000 for a standard full remodel, with DFW cost per square foot typically running $70–$250. You'll get a free, line-item estimate before any work begins.",
  },
  {
    question: "Is the 50% off installation offer real?",
    answer:
      "Yes — it's active this month on qualifying projects. Ask us for the full terms when you request your free estimate.",
  },
  {
...
export default function AffordableBathroomRemodelFortWorthPage() {
  return (
    <>
        ...
        <div className="container relative grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-sm font-medium">
              Starting at {cosmeticTier.range.split(" – ")[0]} · This Month Only
            </p>
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl leading-tight">
              Affordable Bathroom Remodel Fort Worth
            </h1>
            <p className="mt-6 text-lg text-gray-300 leading-relaxed">
              Real bathroom remodels starting at {cosmeticTier.range.split(" – ")[0]} — plus 50% off
              installation this month. Licensed, insured, and done on schedule.
            </p>
      ...
      <section className="border-b bg-white py-8">
        <ul className="container grid grid-cols-2 gap-6 md:grid-cols-4 text-center">
          ...
          <li>
            <p className="text-3xl font-bold text-primary">{cosmeticTier.range.split(" – ")[0]}</p>
      ...
      <section className="bg-muted py-14 md:py-20">
        <div className="container">
          ...
          <p className="mt-4 text-center text-muted-foreground max-w-2xl mx-auto">
            An actual bathroom remodel from one of our Fort Worth projects — not a stock photo.
          </p>
          <div className="mt-10 grid gap-4 sm:grid-cols-2 max-w-3xl mx-auto">
            <div className="relative aspect-[4/3] overflow-hidden rounded-lg border shadow-sm">
              <Image
                ...
                alt="Dated bathroom with green walls and an old tub-shower combo before remodel"
                fill
                loading="lazy"
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-lg border shadow-sm">
              <Image
                ...
                alt="Finished walk-in shower with white subway tile after remodel"
                fill
                loading="lazy"
                sizes="(max-width: 640px) 100vw, 50vw"
                className="object-cover"
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 max-w-3xl mx-auto">
            <div className="rounded-lg border bg-card p-6">
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
                &ldquo;They converted our cramped tub into a beautiful walk-in shower with frameless
                glass. The tile work is flawless — friends assume we spent twice what we did. Clean
                crew, honest pricing.&rdquo;
              </p>
            ...
            <div className="rounded-lg border bg-card p-6">
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
                &ldquo;Our master bath went from builder-grade to spa-level. Heated floors, a soaking
                tub, marble-look porcelain everywhere. Done in 19 days, exactly as promised.&rdquo;
              </p>
              <p className="mt-4 text-sm font-semibold text-charcoal">
      ...
      <section className="bg-muted py-14 md:py-20">
        <div className="container max-w-3xl">
          <h2 className="text-center text-3xl md:text-4xl font-bold tracking-tight text-charcoal">
            Affordable Bathroom Remodel — FAQs
          </h2>
      ...
      <section id="estimate-form" className="bg-primary py-14 md:py-20 text-white">
        <div className="container max-w-2xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
            Ready for an Affordable Bathroom Remodel?
          </h2>
          <p className="mt-4 text-lg text-blue-100 leading-relaxed">
            Remodels start at {cosmeticTier.range.split(" – ")[0]}, and the 50% off installation offer
            is available for a limited time this month. Get your free estimate before it&apos;s gone.
          </p>
